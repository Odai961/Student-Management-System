            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input
                            ...
                            id="first_name"
                            name="first_name"
                            value="<?= $_POST['first_name'] ?? $student['first_name'] ?? '' ?>"
                ...
                <div class="form-group">
                    ...
                    <input
                            ...
                            id="last_name"
                            name="last_name"
                            value="<?= $_POST['last_name'] ?? $student['last_name'] ?? '' ?>"
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input
                            ...
                            id="birth_date"
                            name="birth_date"
                            value="<?= $_POST['birth_date'] ?? $student['birth_date'] ?? '' ?>"
                    >
                ...
                <div class="form-group">
                    ...
                    <input
                            ...
                            id="email"
                            name="email"
                            value="<?= $_POST['email'] ?? $student['email'] ?? '' ?>"
